    ...
    <el-row>
      ...
      <el-col :span="24">
        <el-table v-loading="loading" :data="page.records" class="bill-table" size="" style="width: 100%">
          ...
          <el-table-column prop="createName" label="教师" width="200" align="center"></el-table-column>
          <el-table-column prop="createTime" label="到期时间" :formatter="baseTableFormatTime" width="" align="center"></el-table-column>

          <el-table-column fixed="right" label="操作" align="rigth" width="180">
            <template slot-scope="scope">
              <el-button type="text" size="mini" @click="updateItem(scope.row.id)">转班</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-col>
  ...
  export default {
    ...
    methods: {
      ...
      listStudent() {
        const _this = this;
        _this.loading = true;
        _this.httpUtils.appPost('/student/main/pageBan', _this.query).then(function (res) {
          _this.loading = false;
      ...
      chargePost(sid) {
        const _this = this;
        _this.httpUtils.appPost('/student/main/ban', _this.xiu).then(function (res) {
          _this.listStudent();
