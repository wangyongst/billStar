<template>
  <div>
    ...
    <el-row :gutter="2">
      <el-col :span="2">
        <el-button type="primary" size="medium " style="background: #007aff;"><p><span style="font-size:200%">{{page.courseCount.studentTotal}}</span></p>总人数</el-button>
      </el-col>
      <el-col :span="2">
        <el-button type="primary" size="medium " style="background: #007aff;"><p><span style="font-size:200%">{{page.courseCount.courseTotal}}</span></p>总科次</el-button>
      </el-col>
      <el-col :span="2" v-for="item in page.courseCount.subjectCounts">
        <el-button size="medium " type="danger" style="background: #cf2d28"><p><span style="font-size:200%">{{item.total}}</span></p>{{item.name}}</el-button>
      </el-col>
      <el-col :span="2">
        <el-button type="primary" size="medium " style="background: #007aff;"><p><span style="font-size:200%">{{page.courseCount.mankeTotal}}</span></p>满科次</el-button>
      </el-col>
      <el-col :span="2">
        <el-button type="primary" size="medium " style="background: #007aff;"><p><span style="font-size:200%">{{page.courseCount.manbanlv}}</span></p>满班率</el-button>
      </el-col>
    </el-row>
