  ...
  <el-row id="body">
    ...
    <el-col :span="24">
      <el-table v-loading="loading" :data="list" class="bill-table">
        ...
        <el-table-column prop="name" label="学生班级"></el-table-column>
    ...
    <!--    新增修改框-->
    <el-dialog class="bill-dialog" v-bind:title="classNo.type === 0 ?'新增学生班级' : '修改学生班级'"
...
<script>
  export default {
    ...
    methods: {
      ...
      deleteItem(id) {
        const _this = this;
        _this.httpUtils.appPost('/sys/my/class/delete?id=' + id).then(function (res) {
          _this.listClassNo();
      ...
      updatePost() {
        const _this = this;
        _this.httpUtils.appPost('/sys/my/class/update', _this.classNo).then(function (res) {
          _this.listClassNo();
      ...
      createPost() {
        const _this = this;
        _this.httpUtils.appPost('/sys/my/class/save', _this.classNo).then(function (res) {
          _this.listClassNo();
          _this.createDialogVisible = false;
          _this.baseSuccessNotify(res);
        }, _this.operateFail);
