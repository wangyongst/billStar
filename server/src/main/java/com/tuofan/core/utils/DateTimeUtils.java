...
public class DateTimeUtils extends DateUtils {
	...
	public static final String DATE_FORMAT_NOJOINER_HOUR = "yyyyMMddHH";

	public static final String DATE_FORMAT_NOJOINER_MINUTE = "yyyyMMddHHmm";

	public static final String DATE_FORMAT_NOJOINER_SECOND = "yyyyMMddHHmmss";
	...
	private static String[] parsePatterns = { "yyyy-MM-dd", "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm", "yyyy-MM",
			...
			"yyyy.MM.dd HH:mm", "yyyy.MM", "yyyyMMddHHmmss", "yyyyMMddHHmm" };
